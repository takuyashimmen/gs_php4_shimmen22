...
//２．質問取得SQL作成
$stmt = $pdo->prepare("SELECT * FROM ogiri_question WHERE id_question = :id_question "); //すでにあるのをとるからバインドは不要
$stmt->bindValue(':id_question', $id_question, PDO::PARAM_STR);      //Integer（数値の場合 PDO::PARAM_INT)
$status = $stmt->execute();
    ...
    <div class="wrap">
        ...
        <main>
            ...
            <div class=q-container>
                ...
                <form method="POST" action="insert_twist.php">
